...
public class PlanProcedureController : ControllerBase
{
    ...
    [HttpPost("AssignDeAssignUserPlanProcedure")]
    public async Task<IActionResult> AssignDeAssignUserPlanProcedure(AssignDeAssignUserPlanProcedureCommand command, CancellationToken token)
    {
